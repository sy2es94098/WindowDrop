...
public class NeighborDiscovery {
    ...
    public NeighborDiscovery(JmDNS jmdns) throws UnknownHostException {
        userInfos = new HashSet<UserInfo>();
        localAddr = InetAddress.getLocalHost().getHostAddress();
        jmdns.addServiceListener("_test._tcp.local.", new NeighborListener());
    }

    public static Set<UserInfo> getNeighbors() {
        return userInfos;
    }
